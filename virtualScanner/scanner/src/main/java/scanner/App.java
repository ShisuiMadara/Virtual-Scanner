        ...
        throws IOException
    {
       ...
       ConcurrentHashMap<String, Integer> status = new ConcurrentHashMap<>();
        ...
        while(completed.size() != n)
        {
            ...
            //to simulate the actual running of belt, we delay the process by some time
            //this time is the time required for a product to travel the distance between two scanners
            ...
            {
                System.out.println("Interrupted Exception while thread sleeping");
            }
            ...
            while(itr2.hasNext())
            {
                ...
                String msg = scannermessage.CustomMessage();
